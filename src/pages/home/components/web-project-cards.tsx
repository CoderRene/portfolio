...
import BrowserScreen from "./browser-screens";
  ...
  return (
    ...
    >
      ...
      <div className="relative h-44 overflow-hidden flex items-center justify-center" style={{ background: `${project.color}0a` }}>
        ...
        <div
          className="relative w-[200px] h-[130px] rounded-lg overflow-hidden"
          style={{
            background: "#080B12",
        ...
        >
          <div
            className="flex items-center gap-1.5 px-2 h-5 border-b"
            style={{ background: "#0D1220", borderColor: `${project.color}33` }}
          >
            <span className="w-1.5 h-1.5 rounded-full" style={{ background: "#f72585" }} />
            <span className="w-1.5 h-1.5 rounded-full" style={{ background: "#E8A017" }} />
            <span className="w-1.5 h-1.5 rounded-full" style={{ background: "#06d6a0" }} />
            <div
              className="ml-1 flex-1 h-2.5 rounded text-[6px] leading-[10px] px-1.5 truncate"
              style={{ background: "#1A2030", color: "#6B7A99" }}
            >
              {project.title.toLowerCase()}.app
            </div>
          </div>
          <BrowserScreen type={project.screen} />
        </div>
